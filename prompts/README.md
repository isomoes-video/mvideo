...
All prompts instruct the agent to use the existing Typer CLI in `main.py`. They
do not authorize replacing the CLI with ad hoc FFmpeg commands or new scripts.
